...
매물 정보가 흩어져 있거나, 뷰잉 예약 과정이 번거롭고, 모르는 사람과의 거래에서 오는 불안감이 크기 때문입니다.
<p>하니홈은 이러한 문제를 해결하기 위해 다음과 같은 기능을 제공합니다:</p>

- 🏠 **검증된 매물 & 호스트**
  - 신원이 보증된 호스트만 매물 등록 가능  
  - 계약 조건과 비용까지 투명하게 확인 가능  

- 📅 **뷰잉 예약 & 관리**
  - 호스트가 제시한 일정 중 게스트가 원하는 시간 직접 예약  
  - 예약 내역은 **뷰잉 관리 탭**에서 확인  
  - 뷰잉 시 **체크리스트 & 노트 기능** 활용 가능  
...
| <img src="https://avatars.githubusercontent.com/u/127955729?v=4" width="150" height="150"/> | <img src="https://avatars.githubusercontent.com/u/80269181?v=4" width="150" height="150"/> | <img src="https://avatars.githubusercontent.com/u/130209517?v=4" width="150" height="150"/> | <img src="https://avatars.githubusercontent.com/u/116480651?v=4" width="150" height="150"/> | 
| :-----------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------: | 
| 원채영 <br/> [@chaeyoungwon](https://github.com/chaeyoungwon) | 신수진 <br/> [@lemoncurdyogurt](https://github.com/lemoncurdyogurt) | 최근호 <br/> [@WithFortuna](https://github.com/WithFortuna) | 이석원 <br/> [@leerura](https://github.com/leerura) |  
| **FE** | **FE** | **BE** | **BE/ FE** |
